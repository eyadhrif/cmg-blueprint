...
export default function EditorialStatement() {
  return (
    <section className="bg-light py-32 lg:py-40 border-b border-black/6">
      <div className="max-w-[1280px] mx-auto px-6">
        <motion.div className="max-w-4xl mx-auto text-center" {...fadeUp}>
          ...
          <blockquote className="font-serif text-3xl sm:text-4xl lg:text-5xl leading-[1.2] text-text-dark -mt-20 tracking-tight">
          ...
          <div className="mt-10">
            ...
            <cite className="font-serif text-base text-text-dark-muted not-italic">
              Mourad Guellaty
