  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold text-text-primary">Actualités</h1>
          <p className="text-text-muted text-sm mt-1">
            Gérez les actualités, brèves fiscales et annonces du cabinet.
          </p>
        </div>
        <Link href="/admin/news/create">
          <Button className="bg-accent hover:bg-accent/90 text-white">Nouvelle actualité</Button>
        </Link>
      </div>
