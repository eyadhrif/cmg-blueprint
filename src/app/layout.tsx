...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    'commissariat aux comptes Tunisie',
    'conseil fiscal Tunisie',
    'Cabinet Mourad Guellaty',
    'MG & Associés',
    'La Marsa Tunis',
    'création entreprise Tunisie',
    'IFRS Tunisie',
    'due diligence Tunisie',
    'audit financier Tunis',
  ],
  authors: [{ name: 'Cabinet Mourad Guellaty & Associés', url: 'https://www.cabinetguellaty.com' }],
  creator: 'Cabinet Mourad Guellaty',
  publisher: 'Cabinet Mourad Guellaty',
  robots: {
    index: true,
    follow: true,
    googleBot: {
  ...
  openGraph: {
    ...
    description:
      'Audit légal, commissariat aux comptes, conseil fiscal et expertise comptable à La Marsa, Tunis.',
    images: [
